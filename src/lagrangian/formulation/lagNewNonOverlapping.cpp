...
void lagNewNonOverlapping::init(){
...
//void lagFlow::updateAssignment_k(int d, BellmanFord< ListDigraph, ListDigraph::ArcMap<double> > &path, const ListDigraph::Node &SOURCE, const ListDigraph::Node &TARGET){
void lagNewNonOverlapping::updateAssignment_k(int label, DijkstraCostE &path, const ListDigraph::Node &SOURCE, const ListDigraph::Node &TARGET){
...
//double lagFlow::getRealCostFromPath(int d, BellmanFord< ListDigraph, ListDigraph::ArcMap<double> > &path, const ListDigraph::Node &SOURCE, const ListDigraph::Node &TARGET){
double lagNewNonOverlapping::getRealCostFromPath(int label, DijkstraCostE &path, const ListDigraph::Node &SOURCE, const ListDigraph::Node &TARGET){
    double total = 0.0;
    ListDigraph::Node currentNode = TARGET;
    while (currentNode != SOURCE){
        ListDigraph::Arc arc = path.predArc(currentNode);
...
void lagNewNonOverlapping::runGeneralObj(){
    ...
    for (int e = 0; e < instance.getNbEdges(); e++){
        ...
        DijkstraCostE shortestPath((*vecEGraph[e]), addFinalOneSlicePerDemand);
